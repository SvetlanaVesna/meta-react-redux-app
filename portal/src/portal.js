...
async function init() {
    ...
    await loadApp('ui.react.1', '/ui/ui.react.1', '/ui/ui.react.1/singleSpaEntry.js', '/ui/ui.react.1/store.js', globalEventDistributor);

    // app2: The URL "/app2/..." is being redirected to "http://localhost:9002/..." this is done by the webpack proxy (webpack.config.js)
    await loadApp('ui.react.2', '/ui/ui.react.2', '/ui/ui.react.2/singleSpaEntry.js', '/ui/ui.react.2/store.js', globalEventDistributor);
